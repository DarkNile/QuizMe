...
class _StartQuizState extends State<StartQuiz> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: Color.fromRGBO(10, 30, 10, 1),
      body: Container(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FadeAnimation(1, Text("Tutorial Guide",
                    style: TextStyle(color: Colors.white, fontSize: 50),)),
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("The test contains 20 MCQ Questions that you should answer in at most 20 Minutes \n\n "
                      "Relax and Press the Start Button when you are ready \n\n Good Luck :)",
